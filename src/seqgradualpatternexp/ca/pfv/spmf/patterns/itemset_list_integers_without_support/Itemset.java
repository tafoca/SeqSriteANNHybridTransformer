package seqgradualpatternexp.ca.pfv.spmf.patterns.itemset_list_integers_without_support;
...
public class Itemset{
	 ...
	 */
	public Itemset cloneItemSetMinusItems(Map<String, Set<String>> mapSequenceID, double relativeMinsup) {
	...
	public boolean containsAll(Itemset itemset2){
		...
		for(String item : itemset2.getItems()){
